...
/**
 * Initialize the Gemini client once for reuse across the session.
 * Always rely on process.env.API_KEY as the exclusive key source.
 */
const ai = new GoogleGenAI({ apiKey: process.env.API_KEY });

export const generatePersonaImage = async (city: string, age: number, gender: Gender): Promise<string> => {
  // User prompt preserved exactly as requested
